namespace IoTEdgeBogusDataGenerator
{
    ...
    {
        static int counter;
        static volatile DesiredPropertiesData desiredPropertiesData;
            ...
            while(true)
            {
                try
                {
                    if(desiredPropertiesData.SendData)
                    {
                        ...
                        var messageBody = BogusDataFactory.CreateBogusData(counter);
;
                        ...
                        await moduleClient.SendEventAsync("bogusDataOutput", message);
